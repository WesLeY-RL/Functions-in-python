...
# Criar um cliente
cliente = PessoaFisica(nome="João Silva", data_nascimento="01-01-1980", cpf="12345678900", endereco="Rua A, 123")

# Abrir uma conta corrente para o cliente
conta_corrente = ContaCorrente.nova_conta(cliente, numero="1234-5")
